...
interface AdminFeaturedModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: (productId: string, imageUrl: string) => void;
  productId: string;
  currentImage: string;
}

export function AdminFeaturedModal({ isOpen, onClose, onSuccess, productId, currentImage }: AdminFeaturedModalProps) {
