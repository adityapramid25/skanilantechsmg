...
export default function ProductPage() {
  const product = {
    ...
    // PERHATIKAN DI SINI: Menggunakan tanda backtick (`) di awal teks
...
Meningkatkan retensi (daya ingat).`, // DAN di akhir teks juga menggunakan backtick (`)
    features: [
      ...
      { icon: <TrendingUp className="w-6 h-6 text-violet-600" />, title: 'Peningkatan Engagement', desc: 'Menaikkan tingkat interaksi pengguna.' },
      { icon: <Users className="w-6 h-6 text-violet-600" />, title: 'Kompetisi Sehat', desc: 'Leaderboard untuk memacu semangat.' },
      { icon: <Target className="w-6 h-6 text-violet-600" />, title: 'Pencapaian Target', desc: 'Membantu mencapai tujuan bisnis Anda.' },
      { icon: <Award className="w-6 h-6 text-violet-600" />, title: 'Analitik Lengkap', desc: 'Laporan performa dan perilaku pengguna.' },
    ]
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          >
            ...
            <div className="prose prose-lg prose-slate prose-violet">
              {/* Penting: whitespace-pre-wrap di sini agar enter-nya terbaca */}
