...
const galleryImages = [
  ...
  { id: 3, src: 'https://ik.imagekit.io/skanilantech/Web%20Component/rfid_1-1.png', alt: 'rfid' },
  { id: 4, src: 'https://ik.imagekit.io/skanilantech/Web%20Component/hidroponik_1-1', alt: 'Hidroponik' },
];
